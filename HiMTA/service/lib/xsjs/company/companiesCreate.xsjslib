...
function companiesCreate(param){
    ...
    //TODO now HERE you have oCompany object. Similar to xsjs/lib/company/company.xsjslib method doPost line 13

	//Get Next Personnel Number
	pStmt = param.connection.prepareStatement('select "HiMTA::compid".NEXTVAL from dummy');
